		...
		<div class="container">
			<div class="col-md-9 product-w3ls-right">
				...
				<ol class="breadcrumb breadcrumb1">
					...
					<li class="active">Publicado</li>
					<div class="text-right">
					<div>
					<a href="mapa"><i class="fa fa-map-marker" aria-hidden="true"></i>Ver Mapa</a>
					</div>
				</ol>
				<div class="clearfix"> </div>
				<!-- //breadcrumbs -->
				...
				<div class="products-row">
					<div class="col-md-3 product-grids">
						...
						<div class="agile-products">
							...
							<div class="agile-product-text">
								...
								<h6> $1,000,000 Millon</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" />
									<input type="hidden" name="w3ls_item" value="Apartamento" />
									<input type="hidden" name="amount" value="$1,000,000 Millon" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">
								<h5><a href="">Torre</a></h5>
								<h6> $56,000,000 Millones</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" />
									<input type="hidden" name="w3ls_item" value="Torre" />
									<input type="hidden" name="amount" value="56,000,000 Millones" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href=""><img src="images/e3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="">Aparta Hotel</a></h5>
								<h6> $1,500,000 Mil</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
									<input type="hidden" name="w3ls_item" value="Aparta Hotel"/>
									<input type="hidden" name="amount" value="1,500,000 Mil0" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href=""><img src="images/e4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="">Hotel</a></h5>
								<h6> $25,000,000 Millones</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
									<input type="hidden" name="w3ls_item" value="Hotel"/>
									<input type="hidden" name="amount" value="25,000,000 Millones"/>
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<div class="galry-like">
						...
						<h4><a href="">Desde</a></h4>
						<h5>$1,000,000 Millon</h5>
					</div>
				</div>
			</div>
			<div class="clearfix"> </div>
