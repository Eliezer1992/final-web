...
<body>
				...
				<ul>
					<li class="dropdown head-dpdn">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="principal">Registrate</a></li>
						</ul>
					</li>
	...
	<div class="login-page">
		<div class="container">
			<h3 class="w3ls-title w3ls-title1">Crear Cuenta</h3>
			<div class="login-body">
				<form action="#" method="post">
					<input type="text" class="user" name="name" placeholder="Nombre" required="">
					<input type="text" class="user" name="email" placeholder="Correo email" required="">
					<input type="password" name="password" class="lock" placeholder="Contraseña" required="">
					<a class="btn btn-primary" href="login">REGISTRAR</a>
			...
			<h6>Ya tiene tu cuenta? <a href="login">Iniciar sesión »</a> </h6>
		</div>
	</div>
	<!-- //sign up-page -->
	<!-- footer-top -->
