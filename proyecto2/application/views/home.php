...
<body>
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active"><!-- First-Slide -->
                    ...
                    <div class="carousel-caption kb_caption kb_caption_right">
                        ...
                        <h4 data-animation="animated flipInX">Al mejor precio del mercado</h4>
                    </div>
                </div>
                <div class="item"> <!-- Second-Slide -->
                    <img src="images/8.jpg" alt="" class="img-responsive" />
                    <div class="carousel-caption kb_caption kb_caption_right">
                        <h3 data-animation="animated fadeInDown">Elige la de tu gusto</h3>
                        <h4 data-animation="animated fadeInUp">con la mejor facilidad</h4>
                    </div>
                </div>
                <div class="item"><!-- Third-Slide -->
                    <img src="images/3.jpg" alt="" class="img-responsive"/>
                    <div class="carousel-caption kb_caption kb_caption_center">
                        <h3 data-animation="animated fadeInLeft">Busca tu hogar</h3>
                        <h4 data-animation="animated flipInX">en la mas completa inmobiliaria</h4>
                    </div>
                </div>
            </div>
            <!-- Left-Button -->
		...
		<div class="container">
			<div class="welcome-info">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					...
					<div class="clearfix"> </div>
					<h3 class="w3ls-title">QUE ESPERA SE PARTE DE LA FAMILIA!</h3>
								...
								<div id="owl-demo" class="owl-carousel">
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											<a><img src="images/e1.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">
												<h4><a>Apartamento</a></h4>
												<p>Desde</p>
												<h7>$1,000,000 Millon</h7>
												<p>Telefono</p>
												<h7>829-691-3194</h7>
												<form action="#" method="post">
													<input type="hidden" name="cmd" value="_cart" />
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											...
											<a><img src="images/e3.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">
												<h4><a>Aparta Hotel</a></h4>
												<p>De Oportunidad</p>
												<h7>$1,500,000 Mil</h7>
												<p>Telefono</p>
												<h7>829-632-9225</h7>
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											<a><img src="images/e4.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">
												<h4><a>Hotel</a></h4>
												<p>A Un Buen Precio</p>
												<h7>$25,000,000 Millones</h7>
												<p>Telefono</p>
												<h7>829-691-3194</h7>
												<form action="#" method="post">
													<input type="hidden" name="cmd" value="_cart" />
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											<div class="new-tag"><h6>New</h6></div>
											<a><img src="images/e2.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">
												<h4><a>Torre</a></h4>
												<p>El Paraiso</p>
												<h7>$56,000,000 Millones</h7>
												<p>Telefono</p>
												<h7>829-632-9225</h7>
												<form action="#" method="post">
													<input type="hidden" name="cmd" value="_cart" />
	...
	<div class="soon">
		<div class="container">
			<h3>Inmobiliaria AVE</h3>
			<h4>Confiabilidad a la hora de negociar</h4>
	...
	<div class="deals">
		<div class="container">
			<h3 class="w3ls-title">Bienvenidos A Inmobiliaria AVE </h3>
			<div class="deals-row">
				<div class="col-md-3 focus-grid">
					<a class="wthree-btn">

						<h3 class="clrchg">Casa</h3>
					</a>
				</div>
				<div class="col-md-3 focus-grid">
					<a class="wthree-btn wthree1">

						<h3 class="clrchg">Apartamento</h3>
					</a>
				</div>
				<div class="col-md-3 focus-grid">
					<a class="wthree-btn wthree2">

						<h3 class="clrchg">Solar</h3>
					</a>
				</div>
				<div class="col-md-3 focus-grid">
					<a class="wthree-btn wthree3">

						<h3 class="clrchg">Finca</h3>
					</a>
				</div>
